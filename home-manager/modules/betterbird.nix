{lib, ...}: let
  ...
  status-icons-prefix = ".local/share/flatpak/app/eu.betterbird.Betterbird/current/active/files/share/icons/hicolor/scalable/status/eu.betterbird.Betterbird-";
in {
